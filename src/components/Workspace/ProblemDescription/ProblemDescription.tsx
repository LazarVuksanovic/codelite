				...
				<div className='px-5'>
					...
					<div className='w-full'>
						...
						{!loading && currentProblem && (
							...
							<div
								className={`${problemDifficultyClass} inline-block rounded-[21px] bg-opacity-[.15] px-2.5 py-1
							...
							<div className='flex items-center cursor-pointer hover:bg-dark-fill-3 space-x-1 rounded p-[3px]
							ml-4 text-lg transition-colors duration-200 text-green-s text-dark-gray-6'
...
function useGetUsersDataOnProblem(problemId: string){
	...
	useEffect(() => {
		const getGetUsersDataOnProblem = async () =>{
			const userRef = doc(firestore, "users", user!.uid);
